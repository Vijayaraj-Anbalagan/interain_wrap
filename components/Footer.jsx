...
const Footer = () => (
  <section className={`${styles.yPaddings} bg-primary-black`}>
    <motion.div
    ...
    >
      ...
      >
        <div className="">
          ...
          />
          <div className="text-[16px] text-white w-[80%] mx-auto my-1 text-center">
        ...
        <div className="flex my-10 md:my-0 md:block lg:flex mx-12 lg:mx-[100px] xl:mx-[150px]">
          <div className=" text-white min-w-max text-[15px] md:text-[16px]">
          ...
          <div className="text-white text-[15px] md:text-[16px] min-w-max md:mt-8 lg:mt-0 ml-12 md:ml-0 lg:ml-20 xl:ml-24">
            <div className="text-[16px] mb-4">
              Quick Links
            </div>
            <Link href="/" className="block mt-1">
    ...
    <div className="bg-primary-black text-white text-center py-1 mt-5">
      © 2021 Interain. All rights reserved.
    </div>
  </section>
);
